...
# For use with Image file versions: USpassport.jpg, USface.jpg
...
class NYlotto(confTest.NYlottoBASE):
    ...
    def test_regUSPassportBrowserFail(self):
        ...
        try:
            driver.execute_script('alert("Test will pause for max of 5 minutes while tester uploads USpassport.jpg, USface.jpg for gov id verification. '
