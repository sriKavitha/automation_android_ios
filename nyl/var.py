...
class cognitoAWS:
        ...
        aws_cognito_cognitoPageHeader = [By.XPATH, '//nav[@aria-label="Navigation drawer"]//span[contains(text(),"Amazon Cognito")]','Amazon Cognito']
        aws_cognito_userPoolName = [By.XPATH, '//table[@role="table"]//tr[@data-selection-item="item"]//td[2]/a', 'User Pool Name']
        aws_cognito_userNamelistBox = [By.XPATH, '//button[@type="button"]  [contains(@class,"awsui_button-trigger")]', 'UserName ListBox']
        aws_cognito_searchUserAttribute = [By.XPATH, '//input[@placeholder="Search users by attribute"]', 'Search user by attribute']
        aws_cognito_verifyEmail = [By.XPATH, '//div[contains(text(),"User name")]//ancestor::table/tbody//td[3]', 'Verify Email address']
        aws_cognito_clickUserNameDetails = [By.XPATH, '//div[contains(text(),"User name")]//ancestor::table/tbody//td[2]', 'User Name details']
        aws_cognito_userPools = [By.XPATH, '//input[@aria-label = "Filter user pools"]','User Pools']
        ...
        aws_cognito_editButton = [By.XPATH, '//span[contains(text(),"Edit")]/ancestor::button', 'Edit button']
        aws_cognito_firstName = [By.XPATH, '//div[@data-testid="required-attribute-given_name"]//input', 'First Name']
        aws_cognito_lastName = [By.XPATH, '//div[@data-testid="required-attribute-family_name"]//input', 'Last Name']
        aws_cognito_address = [By.XPATH, '//div[@data-testid="optional-attribute-address"]//input', 'Address']
        aws_cognito_birthdate= [By.XPATH, '//div[@data-testid="optional-attribute-birthdate"]//input', 'Birth Date']
        aws_cognito_phoneNumber = [By.XPATH, '//div[@data-testid="required-attribute-phone_number"]//input', 'Phone Number']
        aws_cognito_email = [By.XPATH, '//div[@data-testid="required-attribute-email"]//input', 'Email']
        aws_cognito_lexIDNumber = [By.XPATH, '//div[@data-testid="optional-attribute-custom:lex_id"]//input', 'Lex ID Number']
        aws_cognito_govIDNumber = [By.XPATH, '//div[@data-testid="optional-attribute-custom:gov_id"]//input', 'Gov ID Number']
