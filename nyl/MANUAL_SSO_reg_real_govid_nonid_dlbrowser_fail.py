...
class NYlotto(confTest.NYlottoBASE):
    ...
    def test_regNonIDDLBrowserFail(self):
        ...
        try:
            driver.execute_script('alert("Test will pause for max of 5 minutes while tester uploads Random-landscape.jpg, Random-portrait.jpg for gov id verification. '
