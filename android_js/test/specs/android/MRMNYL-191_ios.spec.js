...
// const HomePage = require('../../pages/ios/home-page');
const HomePage = require('../../pages/ios/home-page-ios')
const LoginPage = require('../../pages/ios/login-page-ios')
const Utils = require('../../utils/helperUtils')
describe('iOS app user - Cannot login with invalid credentials', function () {
